              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                    ...
                    <ul className="list-disc list-inside text-amber-700 dark:text-amber-300 text-sm space-y-1">
                      ...
                      <li>Unused namespace prefixes may be removed (e.g., <code className="bg-amber-100 dark:bg-amber-800 px-1 rounded-xs">rdf:</code>, <code className="bg-amber-100 dark:bg-amber-800 px-1 rounded-xs">xml:</code>, <code className="bg-amber-100 dark:bg-amber-800 px-1 rounded-xs">xsd:</code> if not explicitly used)</li>
                      <li>Whitespace and formatting are standardized</li>
                      <li>The shorthand <code className="bg-amber-100 dark:bg-amber-800 px-1 rounded-xs">a</code> is used for <code className="bg-amber-100 dark:bg-amber-800 px-1 rounded-xs">rdf:type</code></li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                    ...
                    <ul className="list-disc list-inside text-slate-600 dark:text-slate-400 text-sm space-y-1">
                      <li>
                        <strong>Title:</strong> Updates <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">dc:title</code>, <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">dcterms:title</code>, or <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">rdfs:label</code> (whichever exists)
                      </li>
                      <li>
                        <strong>Description:</strong> Updates <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">dc:description</code>, <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">dcterms:description</code>, or <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">rdfs:comment</code>
                      </li>
                      <li>If no metadata property exists, <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">dc:title</code> / <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">dc:description</code> is added</li>
