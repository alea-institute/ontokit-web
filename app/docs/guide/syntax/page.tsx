        ...
        <section>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-200 dark:border-slate-700">
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              ...
              (<code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">some</code>,
              <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">only</code>,
              <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">and</code>,
              <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">or</code>,
              <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">min</code>,
              <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">max</code>,
              <code className="bg-slate-200 dark:bg-slate-600 px-1 rounded-xs text-xs">exactly</code>)
