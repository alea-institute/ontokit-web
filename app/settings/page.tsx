...
import { ArrowLeft, Check, AlertCircle, LayoutGrid, Code, Sun, Moon, Monitor, Pencil, Save, ShieldCheck } from "lucide-react";
                  ...
                  identity.commit_email_verified ? (
                    <label className="flex items-start gap-3 text-sm text-slate-700 dark:text-slate-300">
                      <input
                        ...
                        onChange={(e) => handleToggleVerifiedEmail(e.target.checked)}
