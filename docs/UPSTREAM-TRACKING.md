...
status: active
owner: Damien Riehl
updated: 2026-07-07 (PR-6 queued; PR-7 in flight)
---
...
| 7 | Anonymous suggestions *(optional)* | web + api | anonymous session endpoints | no | `IN-PROGRESS` | Extraction in flight 2026-07-07 (api `upstream-queue/anonymous-suggestions` ready: 4 lineage commits + PR-2 stack + migration repoint `t8u9v0w1x2y3`→`v9w0x1y2z3a4` + hardening: dead-beacon fix, public-project gate, 11 new tests, suite 1724; web extraction + fresh tests underway). Row updated to QUEUED when the PR pair opens. |
