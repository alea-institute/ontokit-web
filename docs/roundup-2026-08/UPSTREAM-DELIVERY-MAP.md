...
| T4 | Trust ladder and auto-accept | API synthesis `8d6fc226` and web synthesis `d4ed4581` | web + API | T1, T3 | medium | Complete reviewed local pair is green; authenticated clock UAT remains open and publication remains held |
