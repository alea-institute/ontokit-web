...
| T4 | Trust ladder, distinct decisions, and auto-accept | API combined synthesis `1029cd26` and web combined synthesis `6890216b` | web + API | T1, T3 | medium | Complete reviewed local pair is green; authenticated clock UAT remains open and publication remains held |
| T5 | PR Party | W3, A3, D5 API `f3c4251d`, and mirror-status foundation in combined heads `1029cd26`/`6890216b` | web + API, then `catholicos/.github` answerer asset | T1, T3, T4, demo readiness, org gates | large | Mirror lifecycle/status foundation and D5 are reviewed and green; main PR Party synthesis, deployment, live E2E, and outreach remain gated |
