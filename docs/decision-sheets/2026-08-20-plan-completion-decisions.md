...
> **Superseded:** Use [`2026-08-20-recent-plan-decisions.md`](./2026-08-20-recent-plan-decisions.md). The newer sheet reflects the cleared `folio-python` release gate, resolves optional auth by preserving its established contract, and uses the IDs referenced by the execution plan.
