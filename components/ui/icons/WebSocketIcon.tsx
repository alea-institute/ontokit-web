...
interface WebSocketIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

/**
 * WebSocket icon based on the official WebSocket logo.
 * Compatible with Lucide icon styling conventions.
 */
export const WebSocketIcon = forwardRef<SVGSVGElement, WebSocketIconProps>(
