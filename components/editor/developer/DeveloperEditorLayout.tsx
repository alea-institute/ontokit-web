...
export interface DeveloperEditorLayoutProps {
  ...
  onAddSuggestedProperty?: (iri: string, label: string, parentIri: string, propertyType: "object" | "data" | "annotation", provenance?: AcceptedSuggestionProvenance) => Promise<void>;
